...
function Card({ title, body, icon, index }) {
    ...
    return (
        <div
            className={`bg-b600 min-w-[70vw] lg:min-w-[clamp(30px,40vw,768px)] xl:min-w-[clamp(20px,38.23vw,734px)] w-[clamp(20px,38.23vw,734px)] 
        ...
        >
            ...
            {/* Content */}
            <div className="p-[clamp(10px,3.33vw,64px)] flex flex-col gap-clamp-40 relative z-10">
                <h5 className="text-[clamp(10px,4.17vw,80px)] font-heading font-bold text-balance leading-[0.9] gap-clamp-24 flex items-center">
                    ...
                    <ScrollRevealText
                        text={title}
                        className="text-[clamp(10px,4.17vw,80px)] font-heading font-bold text-balance"
                        yPercent={200}
