...
function Footer() {
  const contactInfo = [
    {
      title: "+20 012 0356 7043 ",
      link: "#"
    },
    {
      title: "info@o-projects.org",
      link: "#"
    },
  ];
  ...
  return (
    <footer className="bg-b500">
      <div className='px-[68px] py-[87px]'>
        {/* top cols */}
        <div className='flex justify-between'>
          {/* first col  */}
          <div className='flex flex-col gap-clamp-71'>
            <div className='flex flex-col gap-clamp-46'>
              {/* footer heading  */}
              <h3 className='text-balance capitalize text-clamp-64 leading-[1] font-heading font-bold mt-[-3px]'>
                We strive to bring <br /> customer’s ideas to life.
              </h3>

              {/* contact ifo */}
              <div className='flex flex-wrap gap-clamp-46 '>
                {contactInfo.map((item, index) => (
                  <div key={item.title}>
                    <Link href={item.link} className='text-clamp-36 underline underline-offset-[7px] decoration-[2px] leadinng-none font-heading text-wd' >{item.title}</Link>
                  </div>
                ))}
                <div>
              ...
              <div className='flex gap-[24px]'>
                {
                  contactLinks.map((item, index) => (
                    <div title={item.title} key={item.ttle}>
                      {item.icon}
                    </div>
                  ))
                }
            ...
            <div className='font-body text-balance flex flex-col gap-[23px]'>
              ...
              <p className=' leading-none'>
                7 Abdelmoneam Fawzy St, Elnozha, Cairo, Egypt
              </p>
            </div>
          </div>
          {/* seconed col  */}
          <div className='me-[250px] mt-[24px]'>
            <Nav />
          </div>
        </div>
        {/* bottom cols */}
