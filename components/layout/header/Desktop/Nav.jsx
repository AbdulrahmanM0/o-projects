...
function AccordionItem({ title, children, open, setOpen }) {
    ...
    return (
        <div className="text-balance">
            ...
            >
                <h3 className="mix-blend-difference text-clamp-18 3xl:text-clamp-24 font-bold text-balance leading-none">Menu</h3>
                {!open ?
                    ...
                    :
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="w-clamp-18 h-clamp-18 3xl:w-clamp-24 3xl:h-clamp-24" viewBox="0 0 24 24" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M19.71 5.71002L18.2901 4.29004L12 10.59L5.71002 4.29004L4.29004 5.71002L10.59 12L4.29004 18.2901L5.71002 19.71L12 13.41L18.2901 19.71L19.71 18.2901L13.41 12L19.71 5.71002Z" fill="white" />
                    </svg>
                }
            </button>

            <div
                className={`overflow-hidden transition-all duration-300 ${open ? " mt-clamp-24" : "max-h-0"
                    }`}
            >
                {children}
            </div>
...
export default function Nav(props) {
    return (
        <div className="w-full rounded-md">
            <AccordionItem {...props} title="First Item">
                <nav className="text-balance">
                    {/* navigaton */}
                    <ul className="p-clamp-18 2xl:p-clamp-24 3xl:p-clamp-32 flex flex-col gap-clamp-18 2xl:gap-clamp-24 3xl:gap-clamp-32 border border-b300 mb-clamp-18 3xl:mb-clamp-24">
