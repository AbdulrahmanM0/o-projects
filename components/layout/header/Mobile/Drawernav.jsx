        ...
        <div className="block lg:hidden">
            <Drawer shouldScaleBackground>
                <DrawerTrigger asChild>
                    <button className="fixed top-[5vh] right-[3.75vw] text-balace z-[500] mix-blend-difference " name="nav icon" title="nav icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="w-clamp-20 w-clamp-24" viewBox="0 0 24 24" fill="none">
