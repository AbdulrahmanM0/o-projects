function ForthBtn({value}) {
  return (
    <button className="relative border border-b650 hover:border-balance flex overflow-hidden group transition-colors duration-300">
      
      {/* Backdrop */}
      <div className="absolute left-0 top-0 h-full w-0 bg-[#F3C921] transition-all duration-500 ease-out group-hover:w-full" />
      ...
      {/* Icon */}
      <div className="bg-[#F3C921] relative z-10 p-clamp-12 2xl:p-clamp-20 border-l border-b800 group-hover:border-balance transition-colors duration-300">
        <svg
