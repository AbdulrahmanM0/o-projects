function ThirdBtn({value}) {
  return (
    <button className="relative border border-b200 hover:border-balance flex overflow-hidden group transition-colors duration-300">
      ...
      {/* Backdrop */}
      <div className="absolute left-0 top-0 h-full w-0 bg-b600 transition-all duration-500 ease-out w-full" />
      ...
      {/* Icon */}
      <div className="relative z-10 p-clamp-12 2xl:p-clamp-20 border-l border-b800 border-balance transition-colors duration-300">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="w-clamp-20 fill-white transition-colors duration-300"
          viewBox="0 0 20 20"
        >
          <path
            fillRule="evenodd"
