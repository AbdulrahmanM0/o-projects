...
function SplashScreen() {
    ...
    const cols = [
        <div key={"b1"} className={textStyle}>Hello..</div>,
        <div key={"b2"} className={textStyle}>Trust..</div>,
        <div key={"b3"}>
        ...
        <div key={"b4"} className={textStyle}>The Best..</div>,
    ]
    ...
    return (
        <section ref={container} className="w-screen h-screen fixed top-0 bottom-0 z-[9999]">
            <div className="w-full h-full grid grid-cols-4 absolute top-0 left-0 relative z-30">
